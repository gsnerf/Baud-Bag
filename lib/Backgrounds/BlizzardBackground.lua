...
function Prototype:RenderMoneyFrameBackground(helper, containerFrame, parentName, renderMoneyFrameOnly)
    ...
    local texture = helper:GetTexturePiece("MoneyLineLeft", 80,84, 213,231, nil, targetHeight)
    ...
    texture = helper:GetTexturePiece("MoneyLineRight", 240,244, 213,231, nil, targetHeight)
    texture:SetPoint("RIGHT", parentName.."Right", "LEFT")
    texture:SetPoint("TOP", moneyFrameName, "TOP", 0, 0)

    -- center part of ONLY the yellow border
    texture = helper:GetTexturePiece("MoneyLineCenter", 85,239, 213,231, nil, targetHeight)
